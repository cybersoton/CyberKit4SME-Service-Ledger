...
curl -sk --request POST \
	...
	https://localhost:6012/v1/signup/admin | jq -r "."
...
curl -sk --request GET \
	--header "Accept: application/json" \
	--header "Authorization: Bearer ${USER_TOKEN}" \
	https://localhost:6011/hospital/status/70778cf1-1078-45cc-8598-2aa3e718b94e | jq -r "."
...
curl -sk --request GET \
	--header "Accept: application/json" \
	--header "Authorization: Bearer ${USER_TOKEN}" \
	https://localhost:6011/hospital/collections/attack/objects/bundle--2a25c3c8-5d88-4ae9-862a-cc3396442317 | jq -r "."
	
#Get versions of a specific STIX object of the Hospital "attack" collection
curl -sk --request GET \
	--header "Accept: application/json" \
	--header "Authorization: Bearer ${USER_TOKEN}" \
	https://localhost:6011/hospital/collections/attack/objects/bundle--2a25c3c8-5d88-4ae9-862a-cc3396442317/versions | jq -r "."
